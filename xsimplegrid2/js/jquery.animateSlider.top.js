...
;(function(j,window,document,undefined)
{
	...
	animateSlider.prototype = 
	{
		...
		init		:	function()
		{
			...
			this.slides			=	this.$element.children(".anim-slide-top");
...
/*if you want dots under slider, remove <1--/-->*/	
			...
			this.slides.eq(this.current).addClass("anim-slide-top-this");
		...
		navigate	:	function(page)
		{
			...
			nextAnimate		=	this.elemAnimate(this.current,this.config);
				...
				/*=========================================*/
				$current.removeClass(" anim-slide-top-this "+classes);
				...
				$next.addClass(" anim-slide-top-this");
			    /*=========================================*/ 
			this.updateDots();
		},
		/**
