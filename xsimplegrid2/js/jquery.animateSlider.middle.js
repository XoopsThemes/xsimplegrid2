...
;(function($,window,document,undefined)
{
	...
	animateSlider.prototype = 
	{
		...
		init		:	function()
		{
			...
			this.slides			=	this.$element.children(".anim-middleslider");
			this.slidesCount	=	this.slides.length;
			this.interval		=	[];//Ovveride config.interval 
			this.current		=	0; //first slide	
	/*if you want dots under slider, remove <1--/-->*/
			...
			this.slides.eq(this.current).addClass("anim-middleslider-this");
		...
		navigate	:	function(page)
		{
			...
			nextAnimate		=	this.elemAnimate(this.current,this.config);
				...
				/*=========================================*/
				$current.removeClass(" anim-middleslider-this "+classes);
				...
				$next.addClass(" anim-middleslider-this");
			    /*=========================================*/ 
			this.updateDots();
		},
		/**
